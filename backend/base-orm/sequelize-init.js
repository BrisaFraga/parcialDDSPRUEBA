...
const farmacias = sequelize.define(
  "farmacias",
  {
    IdFarmacia: {
    ...
    Descripcion: {
      ...
      unique: {
        args: true,
        msg: "esta descripcion ya existe en la tabla!",
      },
    },
    Sucursales: {
      type: DataTypes.INTEGER,
  ...
  },
  {
    // pasar a mayusculas
    hooks: {
      beforeValidate: function (farmacia, options) {
        if (typeof farmacia.Descripcion === "string") {
          farmacia.Descripcion = farmacia.Descripcion.toUpperCase().trim();
        }
      },
    },
